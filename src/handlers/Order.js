...
var updateOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.updateOrder(req.params.id, req.body)];
            case 1:
...
var deleteOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.deleteOrder(req.params.id)];
            case 1:
...
var currentOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id, currentOrder_1, err_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
            ...
            case 1:
                currentOrder_1 = _a.sent();
                res.json(currentOrder_1);
                return [3 /*break*/, 3];
            case 2:
                err_6 = _a.sent();
                res.status(400);
...
var orderRoutes = function (app) {
    ...
    app.get("/orders/:user_id/currentOrder", authenticate_1["default"], currentOrder);
    app.put("/orders/:id", authenticate_1["default"], updateOrder);
    app["delete"]("/orders/:id", authenticate_1["default"], deleteOrder);
};
