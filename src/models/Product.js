...
var ProductsStore = /** @class */ (function () {
    ...
    ProductsStore.prototype.update = function (id, product) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new Error("unable to update product: ".concat(error_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_5 = _a.sent();
                        throw new Error("unable to delete product: ".concat(error_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
