...
var OrdersStore = /** @class */ (function () {
    ...
    OrdersStore.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, orders, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "INSERT INTO orders (status ,user_id, product_id, quantity) VALUES ($1, $2, $3, $4) RETURNING *";
                        return [4 /*yield*/, conn.query(sql, [
                                order.status,
                                order.user_id,
                                order.product_id,
    ...
    OrdersStore.prototype.updateOrder = function (id, order) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, updatedOrder, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "UPDATE orders SET status = $2 , user_id = $3 , product_id = $4 ,  quantity = $5  WHERE id = $1 RETURNING *";
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [
    ...
    OrdersStore.prototype.deleteOrder = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, deletedOrder, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    OrdersStore.prototype.currentOrder = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, currentOrder, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
